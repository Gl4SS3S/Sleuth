...
Officer: 6680513
CaseNum: 402-2-89234444-6680513
...
function draw()
{
	...
	if (det.locationX < 261)
	{
		det.speedX = 1;
		det.speedY = 0;
	} else if (det.locationY > 445 && det.locationX > 260)
	{
		det.speedX = 0;
		det.speedY = -1;
	} else if (det.locationX < 515 && det.locationY < 445)
	{
		det.speedX = 1;
		det.speedY = 0;
	} else if (det.locationX > 515 && det.locationY > 195)
	{
		det.speedX = 0;
		det.speedY = -1;
	} else if (det.locationX < 770 && det.locationY < 195)
	{
		det.speedX = 1;
		det.speedY = 0;
	} else if (det.locationX > 770 && det.locationY > 72)
	{
		det.speedX = 0;
		det.speedY = -1;
	} else if (det.locationX < 905 && det.locationY < 72)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
