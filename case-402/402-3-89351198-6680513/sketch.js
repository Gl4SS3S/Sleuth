...
Officer: 6680513
CaseNum: 402-3-89351198-6680513
...
function draw()
{
	...
	if (det.locationY < 135 && det.locationX > 751)
	{
		det.speedX = 0;
		det.speedY = 1;
	} else if ((det.locationY > 135 && det.locationY < 145) && det.locationX > 385) {
		det.speedX = -1;
		det.speedY = 0;
	} else if (det.locationY < 200 && det.locationX < 385) {
		det.speedX = 0;
		det.speedY = 1;
	} else if ((det.locationY >= 200 && det.locationY < 205) && det.locationX < 705) {
		det.speedX = 1;
		det.speedY = 0;
	} else if (det.locationY >= 200 && det.locationY < 325 && det.locationX >= 705) {
		det.speedX = 0;
		det.speedY = 1;
	} else if ((det.locationY > 325 && det.locationY < 330) && det.locationX > 200) {
		det.speedX = -1;
		det.speedY = 0;
	} else if ((det.locationY > 325 && det.locationY < 441) && det.locationX < 200) {
		det.speedX = 0;
		det.speedY = 1; 
	} else if ((det.locationY > 440 && det.locationY < 445) && det.locationX < 575) {
		det.speedX = 1;
		det.speedY = 0;
	} else if ((det.locationY > 440 && det.locationY < 575) && det.locationX > 575) {
		det.speedX = 0;
		det.speedY = 1;
	} else if ((det.locationY > 575 && det.locationY < 580) && det.locationX > 260) {
		det.speedX = -1;
		det.speedY = 0;
	} else if ((det.locationY > 575 && det.locationY < 635) && det.locationX < 260) {
		det.speedX = 0;
		det.speedY = 1;
	} else if ((det.locationY > 635 && det.locationY < 640) && det.locationX < 705) {
		det.speedX = 1;
		det.speedY = 0;
	} else if ((det.locationY > 635 && det.locationY < 705) && det.locationX > 705) {
		det.speedX = 0;
		det.speedY = 1;
	}
